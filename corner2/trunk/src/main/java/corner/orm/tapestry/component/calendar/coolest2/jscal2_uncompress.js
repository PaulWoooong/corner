...
//            if(this.args.showTime == 24){
//            	var flag = true;
//            	for(var xx = 1 ; xx<= 23 ; xx++){
//            		if(ar == xx){
//            		  flag = false;
//            		  break;
//            	    }
...
//            
    ...
    function H(D) {
        ...
        if (P.bottomBar){
            ar.push("<td>");
            ar.push("<table", ah, "><tr><td><div dyc-btn='clearDate' dyc-cls='hover-bottomBar-clearDate,pressed-bottomBar-clearDate' dyc-type='bottomBar-clearDate' class='DynarchCalendar-bottomBar-clearDate'>", aq("clearDate"), "</div></td></tr></table>");
            ar.push("</td>")
        }
        ar.push("</tr></table>");
        return ar.join("")
