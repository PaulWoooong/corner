 ...
 * @since 0.0.1
 */
@SubModule({ValidationModule.class,StaticAssetModule.class,TreeModule.class,SecurityModule.class})
public class CoreModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(ServiceLocatorDelegate.class,ServiceLocatorDelegateImpl.class);
	 ...
	 */
	public static void contributeComponentClassTransformWorker(OrderedConfiguration<ComponentClassTransformWorker> configuration, ComponentClassResolver resolver, LinkFactory linkFactory) {
		configuration.add("pageRedirect", new PageRedirectWorker(resolver, linkFactory));
	}
	...
	public static void contributeFactoryDefaults(
		...
		configuration
				.add(LichenConstants.REMOTE_SERVER_URL, "http://localhost:5180/lichen/remote.hessian");
	...
	public PageTemplateLocator buildPageTemplateLocatorWithHtml(
		...
		return new PageTemplateLocatorWithHtml(contextAssetFactory
				.getRootResource(), componentClassResolver);
	}

	/**
	 * 复写系统提供的Page Template Locator.
	 * @param configuration 配置文件
	 * @param htmlTemplateLocator html template locator.
	 * @since 0.0.1
	 */
